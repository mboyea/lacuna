  ...
  <form>
    ...
    <fieldset>
      <label for="terms">
        ...
        I agree to the
        <a href="#" on:click={(e) => e.preventDefault()}>Privacy Policy</a>
      </label>
    </fieldset>
  </form>
</section>
...
<section id="typography">
  ...
  <div class="grid">
    <p>
      <a href="#" on:click={(e) => e.preventDefault()}>Primary link</a>
    </p>
    <p>
      <a href="#" class="secondary" on:click={(e) => e.preventDefault()}>Secondary link</a>
    </p>
    <p>
      <a href="#" class="contrast" on:click={(e) => e.preventDefault()}>Contrast link</a>
    </p>
  </div>
  <div class="grid">
...
<section id="form">
  <form>
    ...
    <!-- Buttons -->
    <input type="reset" value="Reset" on:click={(e) => e.preventDefault()}>
    <input type="submit" value="Submit" on:click={(e) => e.preventDefault()}>
  </form>
</section>
<!-- ./ Form elements-->
...
<dialog id="modal-example">
  <article>
    ...
    <footer>
      ...
      >
        Cancel</button
      ><button autofocus data-target="modal-example" on:click={toggleModal}>
        Confirm
      </button>
    </footer>
  </article>
